export const config = {
	mapTitle: 'map-hazardous-waste', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'map-hazardous-waste.vercel.app', // The url provided when deploying the map on Vercel
